...
function thmbxSlider() {
    ...
    console.log($('.how-app-work-slider-wrapper.alt .slider'), $('#how-app-work-slider-pager-2'));
    if ($('.how-app-work-slider-wrapper.alt .slider').length) {
        $('.how-app-work-slider-wrapper.alt .slider').bxSlider({
            // adaptiveHeight: true,
            auto: false,
            controls: false,
            pause: 3000,
            speed: 500,
            pagerCustom: '#how-app-work-slider-pager-2'
        });
    }
