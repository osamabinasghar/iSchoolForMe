            ...
            var h = function () {
                    ...
                    return (
                        "horizontal" === d.settings.mode && d.settings.slideWidth > 0
                            ? d.viewport.width() < d.minThreshold
                                ...
                                : ((b = d.children.first().width() + d.settings.slideMargin), (a = Math.floor((d.viewport.width() + d.settings.slideMargin) / b)))
                ...
                s = function () {
                    ...
                    d.children.length > d.settings.maxSlides && d.active.last && !d.settings.infiniteLoop
                        ? "horizontal" === d.settings.mode
                            ...
                            : "vertical" === d.settings.mode && ((c = d.children.length - d.settings.minSlides), (a = d.children.eq(c).position()), t(-a.top, "reset", 0))
                ...
                v = function () {
                    d.settings.pagerCustom
                        ...
                        : ((d.pagerEl = a('<div class="bx-pager" />')), d.settings.pagerSelector ? a(d.settings.pagerSelector).html(d.pagerEl) : d.controls.el.addClass("bx-has-pager").append(d.pagerEl), u()),
                ...
                D = function (b) {
                    ...
                    b.preventDefault(),
                        d.controls.el.hasClass("disabled") ||
                            ...
                            (c = a(b.currentTarget)),
                            void 0 !== c.attr("data-slide-index") && ((f = parseInt(c.attr("data-slide-index"))), f !== d.active.index && e.goToSlide(f)));
                },
                E = function (b) {
                ...
                J = function () {
                    ...
                    "next" === d.settings.autoDirection
                        ...
                        : (e.prepend(d.children.clone().addClass("bx-clone")), (b = d.children.first().position()), (l = "horizontal" === d.settings.mode ? -b.left : -b.top)),
                        t(l, "reset", 0),
                        (d.settings.pager = !1),
                ...
                R = function (a) {
                    ...
                    (d.touch.end.x = c[0].pageX),
                        ...
                        "fade" === d.settings.mode
                            ? ((g = Math.abs(d.touch.start.x - d.touch.end.x)), g >= d.settings.swipeThreshold && (d.touch.start.x > d.touch.end.x ? e.goToNextSlide() : e.goToPrevSlide(), e.stopAuto()))
                            : ("horizontal" === d.settings.mode ? ((g = d.touch.end.x - d.touch.start.x), (f = d.touch.originalPos.left)) : ((g = d.touch.end.y - d.touch.start.y), (f = d.touch.originalPos.top)),
                              !d.settings.infiniteLoop && ((0 === d.active.index && g > 0) || (d.active.last && 0 > g))
                                  ...
                                  ? (0 > g ? e.goToNextSlide() : e.goToPrevSlide(), e.stopAuto())
                                  : t(f, "reset", 200)),
                        d.viewport.unbind("touchend MSPointerUp pointerup", R),
                        d.viewport.get(0).releasePointerCapture && d.viewport.get(0).releasePointerCapture(d.pointerId);
                },
            ...
            return (
                (e.goToSlide = function (b, c) {
                    ...
                    if (((d.oldIndex = d.active.index), (d.active.index = U(b)), !d.working && d.active.index !== d.oldIndex)) {
                        ...
                        "next" === c
                            ? d.settings.onSlideNext.call(e, d.children.eq(d.active.index), d.oldIndex, d.active.index) || (j = !1)
                            : "prev" === c && (d.settings.onSlidePrev.call(e, d.children.eq(d.active.index), d.oldIndex, d.active.index) || (j = !1)),
                                ...
                                : (d.settings.adaptiveHeight && d.viewport.height() !== m() && d.viewport.animate({ height: m() }, d.settings.adaptiveHeightSpeed),
                                  !d.settings.infiniteLoop && d.carousel && d.active.last
                                      ? "horizontal" === d.settings.mode
                                          ...
                                          : ((f = d.children.length - d.settings.minSlides), (l = d.children.eq(f).position()))
                                      : d.carousel && d.active.last && "prev" === c
                                      ? ((g = 1 === d.settings.moveSlides ? d.settings.maxSlides - r() : (q() - 1) * r() - (d.children.length - d.settings.maxSlides)), (n = e.children(".bx-clone").eq(g)), (l = n.position()))
                                      : "next" === c && 0 === d.active.index
                                      ? ((l = e.find("> .bx-clone").eq(d.settings.maxSlides).position()), (d.active.last = !1))
                                      : b >= 0 && ((i = b * parseInt(r())), (l = d.children.eq(i).position())),
                                  "undefined" != typeof l ? ((h = "horizontal" === d.settings.mode ? -(l.left - k) : -l.top), t(h, "slide", d.settings.speed)) : (d.working = !1)),
